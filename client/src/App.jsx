...
function App() {
    ...
    return (
        <div className="min-h-screen p-6 md:p-12 w-full max-w-6xl mx-auto">
            <header className="mb-16 text-center">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-white shadow-sm border border-gray-100 mb-6">
